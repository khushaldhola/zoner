...
const RightSideBar = () => {
  return (
    <div className="sticky right-0 top-0 z-20 h-screen w-[300px] xl:w-[350px] flex flex-col gap-12 overflow-auto pl-6 pr-10 py-3 max-lg:hidden">
      <div className="flex flex-col gap-4">
        <h2 className="underline">Following</h2>
        <div className="flex flex-col gap-4">Mappings of Users</div>
      </div>
      <div className="flex flex-col gap-4">
        <h2 className="underline">Sugested Peoples</h2>
        <div className="flex flex-col gap-4">Mappings of Users</div>
      </div>
